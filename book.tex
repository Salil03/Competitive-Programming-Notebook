...
\textcopyright{} 2019 Salil Gokhale \\
All rights reserved.
...
\begin{center}
\qrcode[height = 6in, level=H]{https://salil03.github.io/Competitive-Programming-Notebook/}    
\end{center}
...
Shortest path $\delta(u,v)$ from $u$ to $v$ has weight
  ...
  \[ \delta(u,v) = \left\{ \begin{array}{ll}
            ...
            \centerline{\epsfig{file=SSSP_example.eps,height=3cm}}
...
\item No (unique) shortest path exists if graph has cycle with
  ...
  \centerline{\epsfig{file=SSSP_negative.eps,height=3cm}}
...
\centerline{\epsfig{file=dijk_1.eps,width=13cm}}
...
\centerline{\epsfig{file=dijk_2.eps,width=13cm}}
